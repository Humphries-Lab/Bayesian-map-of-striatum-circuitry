...
for stage = 1 : n_stages
    ...
    for test = 1 : n_tests
        ...
        p(test,:) = Delta_pdf(data.posterior.(pairings{test,1}).a(stage, :), ...
            data.posterior.(pairings{test,1}).b(stage, :), ...
            data.posterior.(pairings{test,2}).a(stage,:), ...
            data.posterior.(pairings{test,2}).b(stage, :), ...
            step);
